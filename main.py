...
def main():
    ...
    if master_mode == 'y':
        ...
        while True:
            ...
            print('开始检索相关文章...')
            query_paper_result = query_arxiv(eng_query)
            ...
            response = ollama.chat(
                ...
                messages=[
                    {"role": "", "content": ""},
                    {"role": "user", "content": "Please answer the following question based on the following context by user:\nQuestion: {eng_query}\n" + \
                        f"\n".join(rerank_result)}
                ]
            )
