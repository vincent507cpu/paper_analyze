...
def main_loop():
    ...
    if submit_query_button:
        ...
        # Update the session state with the response and logs
        st.session_state['academic_response'] = response
        st.session_state['logs'] = st.session_state['logs']  # Ensure logs are updated
